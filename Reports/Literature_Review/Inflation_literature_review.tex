...
% \begin{figure}[H]
%     \begin{center}
%         \includesvg[width=0.75\textwidth]{Figures/FRWHorizon.svg}
...
% \begin{figure}[H]
%     \begin{center}
%         \includesvg[width=0.75\textwidth]{Figures/TheFlatnessProblem.svg}
%         \caption{\cite{dimopoulosIntroductionCosmicInflation2020}}
%     \end{center}
% \end{figure}
...
% \begin{figure}[H]
%     \begin{center}
%         \includesvg[width=0.75\textwidth]{Figures/AlphaAttractors.svg}
