...
Combining all of this allows for a mathematical description of inflation, in which inflation is described as a scalar field. Circling back to how the thermal bath is recovered to allow for the Hot Big Bang to occur, at the end of inflation this scalar field decays releasing its energy which then allows for the Hot Big Bang. 

\subsection{The Mathematical Description of Inflation}\label{subsection: Mathematical description of Inflation}
